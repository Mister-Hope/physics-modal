...
// MC_EDGE_TABLE: 256 cube configurations → 12-edge intersection bitmask
export const MC_EDGE_TABLE: readonly number[] = [
...
// MC_TRI_TABLE: triangle vertex indices for each configuration (terminated by -1)
export const MC_TRI_TABLE: readonly (readonly number[])[] = [
  [],
  [0, 8, 3],
  [0, 1, 9],
  [1, 8, 3, 9, 8, 1],
